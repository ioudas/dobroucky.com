...
<div id="siteWrapper">
    ...
    <footer role="contentinfo">
        <div class="footer-above">
            <div class="container">
                <div class="row dnnpane">
                    <div id="footer_25_1" class="footer-col col-md-6 col-sm-6" runat="server"></div>
                    <div id="footer_25_2" class="footer-col col-md-6 col-sm-6" runat="server"></div>
